			...
			<div class="row">
				...
				<div class="{{ $contentColSm }} page-content col-thin-left">
					...
					<div class="post-promo text-center mb-5">
						<h2> {{ 'Do have any item or service you are looking for?' }} </h2>
						<h5>{{ 'Get Sellers and Business people looking for you like a KING to meet your needs. It\'s easier than you think !' }}</h5>
