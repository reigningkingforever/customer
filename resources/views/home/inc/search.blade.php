...
$sForm = [
	...
	'hideTitles'                  => '0',
	'title'                       => 'Find what people need near you',
							...
							<form id="search" name="search" action="{{ lurl(trans('routes.v-search', $attr), $attr) }}" method="GET">
								<div class="row m-0">
									<div class="col-sm-5 col-xs-12 search-col relative">
										...
										<input type="text" name="q" class="form-control keyword has-icon" placeholder="Enter Your product / service... e.g vegetables" value="">
									</div>
									...
									<div class="col-sm-5 col-xs-12 search-col relative locationicon">
										...
										@if ($showMap)
											<input type="text" id="locSearch" name="location" class="form-control locinput input-rel searchtag-input has-icon tooltipHere"
												   placeholder="Your business location" value="" title="" data-placement="bottom"
												   data-toggle="tooltip"
										...
										@else
											<input type="text" id="locSearch" name="location" class="form-control locinput input-rel searchtag-input has-icon"
												   placeholder="Your business location" value="">
										@endif
									</div>
